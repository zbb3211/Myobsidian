...
### 3) 云计算的主要服务模式
- IaaS(Infrastructure as a Service):将软件封装成服务，增强业务性能，降低业务提供成本，降低终端要求。
- PaaS(Platform as a Service):统一平台架构，开放平台能力，引入外部开发创新力量，形成生态系统。
- SaaS(Software as a Service):将硬件设备等基础资源封装成服务供用户使用；低成本、大规模、高效率提供IT基础设施。
...
- A large collection of commodity components
	- PC-based serves(CPUs, DRAM, disks)
	- Ethernet networking
...
1. Capital expenses(CAPEX)
	- Facilities, compute, storge, networking
